...
export const bgsound = tag("bgsound")
export const big = tag("big")
export const blink = tag("blink")
...
export const multicol = tag("multicol")
export const nextid = tag("nextid")
export const nobr = tag("nobr")
export const noembed = tag("noembed")
...
export const spacer = tag("spacer")
